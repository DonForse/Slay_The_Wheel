...
namespace Features.Cards.HUD
{
    public class CardContainer : MonoBehaviour
    {
        ...
        [Header("Alignment")] [SerializeField] private CardAlignment alignment = CardAlignment.Center;

        [SerializeField] private bool allowCardRepositioning = true;

        [Header("Rotation")] [SerializeField] [Range(0f, 90f)]
        private float maxCardRotation;

        [SerializeField] private float maxHeightDisplacement;

        [SerializeField] private CardZoomConfig zoomConfig;

        [SerializeField] private AnimationSpeedConfig animationSpeedConfig;

        [SerializeField] private CardPlayConfig cardPlayConfig;

        [SerializeField] private ClonePreviewManager clonePreviewManager;
        private List<CardWrapper> cards = new();

        private RectTransform rectTransform;
        private CardWrapper currentDraggedCard;
        
        public event EventHandler<CardWrapper> CardPlayed;
        public event EventHandler<CardWrapper> CardDestroyed;
        ...
        void SetUpCards()
        {
            ...
            foreach (Transform card in transform)
            {
                ...
                cards.Add(wrapper);
                wrapper.CardHoverStart += SendCardHover;
                wrapper.CardHoverEnd += SendCardUnhover;
        ...
        private void SendCardUnhover(object sender, CardWrapper e)
        {
            clonePreviewManager.OnCardUnhover(this, e);
        }

        private void SendCardHover(object sender, CardWrapper e)
        {
            if (currentDraggedCard == null)
                clonePreviewManager.OnCardHover(this, e);
        }
        ...
        public void OnCardDragEnd()
        {
            ...
            {
                CardPlayed?.Invoke(this,currentDraggedCard);
