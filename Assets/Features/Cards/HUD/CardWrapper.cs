...
public class CardWrapper : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler,
    ...
    public CardZoomConfig zoomConfig;
    ...
    public event EventHandler<CardWrapper> CardHoverStart;
    public event EventHandler<CardWrapper> CardHoverEnd;
    ...
    public void OnPointerEnter(PointerEventData eventData) {
        ...
        CardHoverStart?.Invoke( this,this);
        isHovered = true;
    }
